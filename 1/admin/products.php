      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <div class="flex">
                     <div class="price"><?= $fetch_products['price']; ?><span>vnd</span><span>vnđ</span></div>
                     <div class="category"><?= $fetch_products['category']; ?></div>
                  </div>
                  <div class="name"><?= $fetch_products['name']; ?></div>
                  <div class="flex-btn">
                     <a href="update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">cập nhật</a>
                     <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('xóa sản phẩm này?');">xoá</a>
                  </div>
               </div>
         <?php
            }
